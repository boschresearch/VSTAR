...
class DDIMSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True):
        ...
        self.register_buffer('betas', to_torch(self.model.betas)) # (1000,)
        self.register_buffer('alphas_cumprod', to_torch(alphas_cumprod)) # (1000,)
        self.register_buffer('alphas_cumprod_prev', to_torch(self.model.alphas_cumprod_prev)) # (1000,)
        ...
        # calculations for diffusion q(x_t | x_{t-1}) and others # (1000,)
    ...
    def ddim_sampling(self, cond, shape,
        ...
        if x_T is None:
            ...
            #img = img[:,:,0:1,:,:].repeat(1,1,shape[2],1,1)
            #print("Use the same noise")
        else:
            img = x_T
        ...
        # !New!
        start_from_index = kwargs.get("start_from_index", 0)
        print("----> Start denoising index: ", start_from_index)
        time_range = time_range[start_from_index:]
